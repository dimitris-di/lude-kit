<!--
Thanks for the PR. Please fill the sections below honestly.
One skill per PR. Read CONTRIBUTING.md if you haven't.
-->
...
- [ ] Handoffs to other skills are named in backticks.
- [ ] I installed the skill locally and triggered it from a real prompt.
- [ ] No reformatting of unrelated files in this PR.

## Sample prompt that should trigger this skill
