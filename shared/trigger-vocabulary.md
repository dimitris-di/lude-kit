...
| Postmortem | postmortem, RCA, root cause, incident write-up, blameless |
...
> Use when {action verbs}, {artifact nouns}, or {situations}. Produces {outputs}. {Anti-trigger if needed}.
