...
6. **List explicit non-goals.** Things in the neighborhood that are not in scope, and why.
...
5. **Post-launch review** scheduled at launch + 2 weeks; agenda includes "did the metric move" and "what surprised us."
...
- **No metric, or metric defined post-launch.** Guarantees you'll claim victory in narrative.
