...
|---|---|
| [`staff-software-architect`](personas/staff-software-architect/SKILL.md) | System design, tech selection, ADRs, build-vs-buy, CTO-grade trade-offs. |
...
9. **Quick reference** — cheat sheet for re-activation.
